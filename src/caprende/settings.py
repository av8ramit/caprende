"""
Django settings for caprende project.
...
SECRET_KEY = '^+(n-$hpr9jhdn3*2vq$j#+@y-i*^=toxs*9uivb6ai%i7_2rb'
...
WSGI_APPLICATION = 'caprende.wsgi.application'
